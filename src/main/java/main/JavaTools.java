...
public class JavaTools {
	...
	static private DijkstraAlgorithm dijkstraAlgorithm = new DijkstraAlgorithm();
	static private Strings string = new Strings();
	static LinkedLists linkedLists = new LinkedLists();
	static private BinarySearch binarySearch = new BinarySearch();
	static private BasicMaths basicMaths = new BasicMaths();
	static private ArraysMethods arrays = new ArraysMethods();
	static private BinaryTrees binaryTrees = new BinaryTrees();
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(
					"aaaa:::"+ string.lengthOfLongestSubstring(case5)
					);
		} catch (Exception e) {
	...
	static TreeNode treeNodeSimetric = new TreeNode(10, new TreeNode(6, new TreeNode(4), new TreeNode(8)), new TreeNode(11));
	static TreeNode ex1TreeNode2 = new TreeNode(1,null, new TreeNode(2));
	static TreeNode non_balanced_tree = new TreeNode(1, new TreeNode (2,new TreeNode(4, new TreeNode(4), new TreeNode(8)), new TreeNode(8, new TreeNode(4), new TreeNode(8))), null);
	...
	static TreeNode simetric1 = new TreeNode(1, new TreeNode(2, new TreeNode(3), new TreeNode(4)), new TreeNode(2,new TreeNode(4), new TreeNode(3))); //[1,2,2,3,4,4,3]
